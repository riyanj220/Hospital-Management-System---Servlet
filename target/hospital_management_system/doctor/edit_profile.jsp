                ...
                <div class="card point-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="../doctorUpdateProfile" method="post">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Date of birth</label> <input type="date" required name="dob" class="form-control"value="${doctObj.dob}">
                            </div>

                            
                            <div class="mb-3">
                                <label class="form-label">Qualification</label> <input required name="qualification" type="text" class="form-control" value="${doctObj.qualification}">
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-Label ">Email</label> <input type="text" required name="email" class="form-control" value="${doctObj.email}" readonly>
                            </div>

                            <div class="mb-3">
                                <label class="form-Label ">Mobile No.</label> <input type="text" required name="mobno" class="form-control" value="${doctObj.mobNo}">
                            </div>
